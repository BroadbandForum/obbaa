...
public class StandardModelDeviceInterface implements DeviceInterface {
    private static final Logger LOGGER = LoggerFactory.getLogger(StandardModelDeviceInterface.class);
    private NetconfConnectionManager m_ncm;
    public static final String IETF_ALARM_NS = "urn:ietf:params:xml:ns:yang:ietf-alarms";

    public StandardModelDeviceInterface(NetconfConnectionManager ncm) {
        this.m_ncm = ncm;
    }

...
public interface DeviceDao extends EntityDAO<Device, DevicePK> {
    ...
    String getVomciFunctionName(String deviceName);

    OnuManagementChain[] getOnuManagementChains(String deviceName);

    String getRemoteEndpointName(String deviceName, String terminationPoint, String networkFunctionName);

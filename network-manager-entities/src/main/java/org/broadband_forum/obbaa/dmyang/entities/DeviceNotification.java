...
@Entity
@YangContainer(name = DeviceManagerNSConstants.DEVICE_NOTIFICATION, namespace = DeviceManagerNSConstants.NS)
public class DeviceNotification {
    ...
    @YangAttribute(name = DeviceManagerNSConstants.EVENT)
    @Column(name = "event")
    ...
    public boolean equals(Object other) {
        ...
        DeviceNotification that = (DeviceNotification) other;

...
public interface DeviceManagerNSConstants {
    ...
    String ALIGNMENT_UNKNOWN = "Alignment Unknown";
    ...
    String EXPECTED_SERIAL_NUMBER = "expected-serial-number";
    String EXPECTED_REGISTRATION_ID = "expected-registration-id";
    ...
    String SOFTWARE_IMAGE_ID = "id";
    String SOFWARE_IMAGE_VERSION = "version";
    String SOFTWARE_IMAGE_IS_COMMITTED = "is-committed";
    String SOFTWARE_IMAGE_IS_ACTIVE = "is-active";
    String SOFTWARE_IMAGE_IS_VALID = "is-valid";
    String SOFTWARE_IMAGE_PRODUCT_CODE = "product-code";
    String SOFTWARE_IMAGE_HASH = "hash";
    String DOT = ".";
    String EQPT_ID = "equipment-id";
    String SOFTWARE_IMAGE = "software-image";

    // VOMCI ONU management constants
    String VOMCI_ONU_MANAGEMENT = "vomci-onu-management";
    String USE_VOMCI_MANAGEMENT = "use-vomci-management";
    String VOMCI_FUNCTION = "vomci-function";
    String ONU_MANAGEMEMT_CHAIN = "onu-management-chain";
    String NETWORK_FUNCTION_LINKS = "network-function-links";
    String NETWORK_FUNCTION_LINK_NAME = "name";

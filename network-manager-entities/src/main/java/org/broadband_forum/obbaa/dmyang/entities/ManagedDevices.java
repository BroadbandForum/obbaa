...
@Entity
@YangContainer(name = DeviceManagerNSConstants.MANAGED_DEVICES, namespace = DeviceManagerNSConstants.NS,
        revision = DeviceManagerNSConstants.REVISION)
public class ManagedDevices {
    ...
    public static final SchemaPath getParentSchemaPath() {
        return DeviceManagerNSConstants.NETWORK_MANAGER_SP;
    }

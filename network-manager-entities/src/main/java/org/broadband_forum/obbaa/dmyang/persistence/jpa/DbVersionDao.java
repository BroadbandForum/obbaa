...
public class DbVersionDao extends AbstractDao<DbVersion, String> {
    public DbVersionDao(PersistenceManagerUtil persistenceManagerUtil) {
        super(persistenceManagerUtil, DbVersion.class);
    }
}

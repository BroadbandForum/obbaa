...
@Entity
@YangContainer(name = DeviceManagerNSConstants.TERMINATION_POINT_B, namespace = DeviceManagerNSConstants.ONU_MANAGEMENT_NS,
        revision = DeviceManagerNSConstants.ONU_MANAGEMENT_REVISION)
public class TerminationPointB {
    @Id
    @YangParentId
    ...
    public boolean equals(Object other) {
        ...
        TerminationPointB that = (TerminationPointB) other;

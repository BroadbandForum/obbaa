...
/**
 * <p>
 * Entity class for GRPC Transport Parameters
 * </p>
 * Created by Ranjitha.B.R (Nokia) on 10/05/2021.
 */
@Entity
@YangContainer(name = NetworkFunctionNSConstants.GRPC_TRANSPORT_PARAMETERS, namespace = NetworkFunctionNSConstants.NS,
        revision = NetworkFunctionNSConstants.REVISION)
public class GrpcTransportParameters {
    @Id
    @YangParentId
    ...
    public boolean equals(Object other) {
        ...
        GrpcTransportParameters that = (GrpcTransportParameters) other;

...
/**
 * <p>
 * Entity class for GRPC Channel
 * </p>
 * Created by Ranjitha.B.R (Nokia) on 10/05/2021.
 */
@Entity
@YangContainer(name = NetworkFunctionNSConstants.GRPC_CHANNEL, namespace = NetworkFunctionNSConstants.NS,
...
public class GrpcChannel {
    ...
    @YangAttribute(name = NetworkFunctionNSConstants.PING_INTERVAL)
    ...
    public boolean equals(Object other) {
        ...
        GrpcChannel that = (GrpcChannel) other;

        if (parentId != null ? !parentId.equals(that.parentId) : that.parentId != null) {
            return false;
        }
        if (pingInterval != null ? !pingInterval.equals(that.pingInterval) : that.pingInterval != null) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (pingInterval != null ? pingInterval.hashCode() : 0);
        return result;
    }
}

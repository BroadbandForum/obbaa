                            ...
                            <bbf-subif-tag:match-criteria>
                                <bbf-subif-tag:tag>
                                    ...
                                    <bbf-subif-tag:dot1q-tag>
                                        ...
                                        <bbf-subif-tag:vlan-id>${fwderVlanId}</bbf-subif-tag:vlan-id>

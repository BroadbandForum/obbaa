...
public class DecodeUnsigned8 implements IpfixDataRecordDecodeMethod {
    ...
    public String decodeDataRecord(byte[] data, int length) throws UtilityException, DataTypeLengthMismatchException {
        if (length != LENGTH) {
            throw new DataTypeLengthMismatchException("Incorrect length for Unsigned8 type: " + length);
        }

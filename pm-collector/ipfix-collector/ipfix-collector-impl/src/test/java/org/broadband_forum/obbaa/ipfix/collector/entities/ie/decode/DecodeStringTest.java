...
public class DecodeStringTest {
    ...
    @Test
    public void testDecodeString() throws UtilityException, DataTypeLengthMismatchException, UnknownHostException, MissingAbstractDataTypeException {
        byte[] data = IpfixUtilities.hexStringToByteArray("44534c31");
        int length = 4;
        IpfixDataRecordDecodeMethod method = new DecodeString();

...
public class IpfixTemplateSetTest {

    //                      12345678 12345678 12345678 12345678
    // set id       3       00000000 00000011
    // set length   28      00000000 00011000
    ...
    @Test
    public void testDecodeTemplateSet() throws NotEnoughBytesException {

        byte[] data = IpfixUtilities.hexStringToByteArray("0003001801030003008D000400290002802A000400000E91");
        IpfixTemplateSet set = new IpfixTemplateSet(data);

        assertEquals(3, set.getHeader().getId());
        assertEquals(24, set.getHeader().getLength());

        IpfixTemplateRecord tr = set.getRecords().get(0);
        ...
        byte[] expectedPadding = IpfixUtilities.hexStringToByteArray("");

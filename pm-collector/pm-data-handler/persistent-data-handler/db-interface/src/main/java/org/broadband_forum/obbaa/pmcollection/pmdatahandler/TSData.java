...
public class TSData {
    ...
    public final ArrayList<TSPointForOnuTelemetry> m_tsPointsOnu;

    public TSData() {
        m_tsPoints = new ArrayList<>();
        m_tsPointsOnu = new ArrayList<>();
    }
    ...
    public List<TSPointForOnuTelemetry> getTSPointsOnu() {
        return m_tsPointsOnu;
    }

    public static class TSPointForOnuTelemetry {
        public static final ArrayList<String> TAG_NAMES = new ArrayList<>(6);

        static { // should be in lexicographic order
            TAG_NAMES.add("bbf-obbaa-vomci-telemetry:telemetry-data");
            TAG_NAMES.add("subscription-id");
            TAG_NAMES.add("onu-name");
            TAG_NAMES.add("collection-time");
            TAG_NAMES.add("last-message");
            TAG_NAMES.add("values");
        }

        public String m_measurement;
        public int m_timestamp;
        public Map<String, String> m_tags;
        public Map<String, String> m_fields;

        public TSPointForOnuTelemetry() {
            m_tags = new HashMap<>(TAG_NAMES.size());
        }

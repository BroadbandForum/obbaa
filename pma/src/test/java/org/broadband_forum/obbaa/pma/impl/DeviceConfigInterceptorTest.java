...
public class DeviceConfigInterceptorTest {
    ...
    private static final QName TYPE_QNAME = QName.create(NS, "2018-05-07", TYPE);
    private static final QName INTERFACE_VERSION_QNAME = QName.create(NS, "2018-05-07", INTERFACE_VERSION);
    private static final QName VENDOR_QNAME = QName.create(NS, "2018-05-07", VENDOR);
        private static final QName MODEL_QNAME = QName.create(NS, "2018-05-07", MODEL);
    private static final QName DEVICE_MANAGEMENT_QNAME = QName.create(NS, "2018-05-07", DEVICE_MANAGEMENT);

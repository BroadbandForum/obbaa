 ...
 */
public class OnuKafkaConsumerJson extends AbstractOnuKafkaConsumer<String> {
    ...
    public OnuKafkaConsumerJson(VOLTManagement voltMgmt, Bundle bundle, DeviceManager deviceManager,

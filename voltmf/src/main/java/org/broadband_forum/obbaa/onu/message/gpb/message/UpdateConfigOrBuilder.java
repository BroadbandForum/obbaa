...
public interface UpdateConfigOrBuilder extends
   ...
   */
  org.broadband_forum.obbaa.onu.message.gpb.message.UpdateConfigInstance getUpdateConfigInst();
  /**
   * <code>.tr451_vomci_nbi_message.v1.UpdateConfigInstance update_config_inst = 1;</code>
   */
  org.broadband_forum.obbaa.onu.message.gpb.message.UpdateConfigInstanceOrBuilder getUpdateConfigInstOrBuilder();
   ...
   */
  org.broadband_forum.obbaa.onu.message.gpb.message.UpdateConfigReplica getUpdateConfigReplica();
  /**
   * <code>.tr451_vomci_nbi_message.v1.UpdateConfigReplica update_config_replica = 2;</code>
   */
